...
Translates between Spoolman's data model and Grove Control's internal
...
async def update_spool(
    *,
    ...
    # set outside Grove Control are preserved.
    tag_nulled = (
...
async def reset_spool_consumed_counter(
    ...
    The read mapping in ``_map_spoolman_spool`` then derives Grove Control's
