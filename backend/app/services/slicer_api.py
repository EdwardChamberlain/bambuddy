...
Grove Control stores user printer/process/filament profiles itself (cloud-synced
...
class SlicerApiService:
    ...
    async def list_bundled_profiles(self) -> dict:
        ...
        Powers the "Standard" tier of Grove Control's SliceModal preset dropdowns.
    ...
    async def slice_with_profiles(
        ...
        *,
        ...
        which Grove Control uses for cross-nozzle-class re-slices (#1493) where
        ...
        its in-memory ProgressStore under this id. Grove Control's slice
