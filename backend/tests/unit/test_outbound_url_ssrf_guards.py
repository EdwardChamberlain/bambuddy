...
- LAN-service (Spoolman, ntfy, webhooks, Home Assistant, Obico ML, the
...
@pytest.mark.parametrize(
    "provider_label",
    ["ntfy server", "webhook endpoint", "Home Assistant endpoint"],
)
...
# exemption.
KNOWN_UNGUARDED_NEEDS_SCHEME_AWARE_GUARD = set()
