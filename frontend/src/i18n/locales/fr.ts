export default {
  ...
  printers: {
    ...
    maintenance: {
      ...
      editFieldHelp: "Quand activé, cette imprimante est mise en pause de MQTT, de la file d'attente et des notifications — utile pour les réparations, les installations Grove Control parallèles ou une suspension temporaire.",
    },
    // Chamber light
  ...
  settings: {
    ...
    ldap: {
      ...
      feature3: 'Les groupes LDAP sont associés aux groupes Grove Control à la connexion',
      ...
      autoProvisionHint: 'Créer automatiquement un compte Grove Control lors de la première connexion LDAP',
      ...
      groupMappingHint: 'Associer les DN de groupes LDAP aux groupes Grove Control. Groupes disponibles : ',
    ...
    manageArchivesDescription: 'Modifier et supprimer des archives d’impression, y compris les anciennes. Ne comprend pas la suppression de leur contribution aux statistiques.',
    ...
    concurrentUploadsTitle: 'Envois simultanés vers les imprimantes',
    concurrentUploadsDescription: "Choisissez combien d'imprimantes indépendantes peuvent recevoir des fichiers en même temps. La valeur 1 conserve le comportement séquentiel historique ; les valeurs plus élevées accélèrent l'envoi au parc mais utilisent davantage de connexions et de bande passante sur l'hôte.",
    concurrentUploadsLabel: 'Sessions d’imprimante actives',
    concurrentUploadsHelp: "La valeur par défaut est 1. Chaque élément indique s'il attend une place dans le pool ou la réservation de son imprimante.",
    ...
    groveControlSoftware: 'Logiciel Grove Control',
    ...
    mqttDescription: 'Publier les événements Grove Control vers un broker MQTT externe pour l\'intégration avec Node-RED, Home Assistant et d\'autres systèmes d\'automatisation.',
  ...
  printModal: {
    ...
    futureDateTime: 'Choisissez une date et une heure futures',
    ...
    filamentOverride: 'Exigences de filament',
    filamentOverrideHint: 'Le profil tranché est utilisé par défaut. Modifiez la couleur ou un sous-type compatible uniquement si nécessaire.',
    selectFilamentSlot: 'Sélectionner un emplacement chargé',
    manuallySelected: 'Sélectionné manuellement',
    automaticallyMatched: 'Associé automatiquement',
    ...
    forceColorMatchHint: 'Exiger la couleur sélectionnée. Désactivez cette option pour utiliser toute couleur de la même famille de matériau.',
  ...
  diagnostic: {
    ...
    check: {
      ...
      external_storage: {
        ...
        skip_unsupported_model: 'Non vérifié — ce modèle d’imprimante ne permet pas d’activer cette option. Vérifiez manuellement l’étape 4 de l’installation.',
      },
      port_rtsps: {
