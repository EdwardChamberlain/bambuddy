export default {
  ...
  nav: {
    ...
    installAppSuccess: 'Grove Control yüklendi',
  },
  ...
  printers: {
    ...
    maintenance: {
      ...
      editFieldHelp: 'Etkinleştirildiğinde, bu yazıcı MQTT, kuyruk gönderimi ve bildirimlerden duraklatılır — tamir, paralel Grove Control kurulumları veya geçici askıya alma için kullanışlıdır.',
    },
    // Hazne ışığı
  ...
  archives: {
    ...
    no3mfBanner: {
      ...
      body: 'Dilimleyici yazıcının SD kartına .gcode.3mf dosyasını bırakmadı, bu nedenle Grove Control küçük resmi veya dilimleyici meta verilerini alamadı. Bu genellikle dilimleyicide (Bambu Studio / OrcaSlicer\'in Cihaz sekmesi) "Gönderilen dosyaları harici depolamada sakla" seçeneğinin kapalı olmasından kaynaklanır.',
  ...
  settings: {
    ...
    manageProjectsDescription: 'Projeler oluşturun, güncelleyin ve silin; arşivleri bunlara ekleyin. Baskıları projeler halinde düzenleyen otomasyonlar için uygundur.',
    projectsBadge: 'Projeler',
    manageArchives: 'Arşivleri yönet',
    manageArchivesDescription: 'Eski baskıları kaldırmak da dahil olmak üzere baskı arşivlerini düzenleyin ve silin. İstatistiklere katkılarını temizlemeyi kapsamaz.',
    ...
    concurrentUploadsTitle: 'Yazıcılara eşzamanlı yükleme',
    concurrentUploadsDescription: 'Aynı anda kaç bağımsız yazıcının dosya alabileceğini seçin. 1 değeri eski sıralı davranışı korur; daha yüksek değerler filo gönderimlerini hızlandırır ancak ana bilgisayarda daha fazla bağlantı ve bant genişliği kullanır.',
    concurrentUploadsLabel: 'Devam eden yazıcı oturumları',
    concurrentUploadsHelp: 'Varsayılan değer 1’dir. Her öğe, havuz yuvasını veya yazıcı rezervasyonunu beklediğinde bunu gösterir.',
    ...
    authDisabledMessage: 'Kullanıcı hesapları oluşturmak, izinleri yönetmek ve Grove Control örneğinizi güvende tutmak için kimlik doğrulamayı etkinleştirin.',
    ...
    disableAuthenticationMessage: 'Kimlik doğrulamayı devre dışı bırakmak istediğinizden emin misiniz? Bu, Grove Control örneğinizi giriş yapmadan erişilebilir hale getirecek. Tüm kullanıcılar veritabanında kalacak ancak kimlik doğrulama devre dışı bırakılacak.',
    disableAuthentication: 'Kimlik Doğrulamayı Devre Dışı Bırak',
    // Ek ayarlar
    configureGroveControl: 'Grove Control\'yi Yapılandır',
    ...
    captureFinishPhotoDescription: 'Baskı tamamlandığında yazıcı kamerasından bir fotoğraf çek. Grove Control, baskı sırasında kısa bir zaman atlamalı kayıt yapar, böylece fotoğraf tabla inmeden önceki andan alınabilir. Bu baskı için zaman atlamalı kaydı etkinleştirdiyseniz dosya saklanır, aksi takdirde fotoğraf çekildikten sonra otomatik olarak silinir.',
    ...
    updateViaHomeAssistant: "Güncellemeler Home Assistant Supervisor tarafından yönetilir. Yeni sürümü yüklemek için Home Assistant'ta Ayarlar → Eklentiler → Grove Control'ye gidin.",
    ...
    encryption: {
      ...
      notConfiguredDesc: 'TOTP gizli anahtarları ve OIDC client_secrets düz metin olarak saklanır. MFA_ENCRYPTION_KEY ayarlayın veya Grove Control\'yi otomatik olarak oluşturmak için yazılabilir bir veri dizini ile yeniden başlatın.',
      ...
      migrationErrorWarning: 'Başlangıçta {{count}} eski satır yeniden şifrelenemedi. Sunucu günlüklerini kontrol edin ve yeniden denemek için Grove Control\'yi yeniden başlatın.',
    },
  ...
  login: {
    ...
    resetStep1: 'Grove Control yöneticinizle iletişime geçin',
    ...
    twoFA: {
      ...
      instructionsTotp: 'Doğrulayıcı uygulamanızı açın ve Grove Control için 6 haneli kodu girin.',
  ...
  // Kurulum sayfası
  setup: {
    title: 'Grove Control Kurulumu',
    subtitle: 'Grove Control örneğiniz için kimlik doğrulamayı yapılandırın',
  ...
  users: {
    ...
    subtitle: 'Kullanıcıları ve Grove Control örneğinize erişimlerini yönetin',
    backToSettings: 'Ayarlara Dön',
    createUser: 'Kullanıcı Oluştur',
    noPermission: 'Bu sayfaya erişim izniniz yok.',
    admin: 'Yönetici',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        ...
        description: 'Dilimleyici profillerinizi Grove Control ile senkronize etmek için Orca Cloud hesabınıza giriş yapın.',
      },
      providers: {
  ...
  inventory: {
    ...
    spoolmanMixedContentBody: 'Grove Control HTTPS üzerinden sunuluyor (ters proxy\'niz aracılığıyla), ancak Spoolman URL\'niz hâlâ düz HTTP. Tarayıcılar güvenlik için karışık içeriği engeller, bu nedenle gömülü Spoolman arayüzü oluşturulamaz. Bunun çalışması için Spoolman\'in HTTPS üzerinden erişilebilir olması gerekiyor.',
    spoolmanMixedContentFixReverseProxy: "Spoolman'i Grove Control ile aynı ters proxy'nin (Traefik / Nginx / Caddy) arkasına HTTPS ile koyun, ardından Ayarlardaki Spoolman URL'sini yeni HTTPS adresine güncelleyin.",
  ...
  printModal: {
    ...
    filamentOverride: 'Filament Gereksinimleri',
    filamentOverrideHint: 'Varsayılan olarak dilimlenmiş profil kullanılır. Rengi veya uyumlu malzeme alt türünü yalnızca gerektiğinde değiştirin.',
    selectFilamentSlot: 'Yüklü bir yuva seçin',
    manuallySelected: 'Elle seçildi',
    automaticallyMatched: 'Otomatik eşleştirildi',
  ...
  backup: {
    ...
    repoIsPublicWarning: "Depo HERKESE AÇIK. Grove Control yedekleri MQTT kimlik bilgilerini, Home Assistant belirteçlerini, Prometheus belirteçlerini, Bambu Cloud e-postanızı ve K-profilleri aracılığıyla yazıcı erişim kodlarını içerir. Sağlayıcınızın ayarlarında depoyu özel hale getirene kadar kaydetme engellenir.",
    repoVisibilityUnknown: 'Depo görünürlüğü belirlenemedi. Grove Control, özel olarak onaylanmamış hiçbir şeye yedekleme yapmayı reddeder; kaydetme engellenecek.',
    ...
    appSettingsDescription: 'Grove Control yapılandırması (tam veritabanı)',
    ...
    localBackupDescription: 'Veritabanı, arşivler, yüklemeler ve tüm dosyalar dahil Grove Control verilerinizin tam bir yedeğini oluşturun.',
    ...
    backupRestoredRestart: 'Yedek geri yüklendi. Lütfen Grove Control\'yi yeniden başlatın.',
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'Notlar yazıcıda değil, Grove Control\'de kaydedilir',
  ...
  virtualPrinter: {
    ...
    enable: {
      ...
      visibleInSlicer: 'Dilimleyici keşfinde "Grove Control" olarak görünür',
    ...
    remoteInterface: {
      ...
      hint: 'SSDP üzerinden tanıtılan ve TLS sertifikasında kullanılan IP adresini geçersiz kıl. Grove Control birden fazla ağ arayüzüne sahip olduğunda kullanışlıdır.',
    },
    mode: {
      title: 'Mod',
      archive: 'Arşiv',
    ...
    caCert: {
      ...
      description: "Sanal yazıcılar Grove Control CA tarafından imzalanmış bir TLS sertifikası kullanır. Bağlantıyı kabul etmesi için bu CA sertifikasını dilimleyicinizin güven deposuna bir kez içe aktarın — komut satırından kopyalamaya gerek yok.",
      copy: 'Kopyala',
      copied: 'Kopyalandı',
      download: 'İndir',
      fingerprint: 'SHA-256',
    ...
    howItWorks: {
      ...
      step2: '3MF dosyalarını Grove Control\'ye yüklemek için Arşiv, İnceleme ve Kuyruk modlarında dilimleyicinizdeki "Gönder" düğmesini kullanın. Dilimleyici "Baskı başarılı" gösterecek — dosya saklanır, yazdırılmaz.',
  ...
  externalLinks: {
    ...
    systemPages: 'Grove Control sayfaları',
  ...
  spoolbuddy: {
    ...
    settings: {
      ...
      backendUrl: 'Grove Control Arka Uç URL\'si',
  ...
  diagnostic: {
    ...
    check: {
      ...
      external_storage: {
        ...
        skip_unsupported_model: 'Kontrol edilmedi — bu yazıcı modelinde seçenek açılamaz. Kurulum adımı 4’ü manuel olarak doğrulayın.',
      },
      port_rtsps: {
      ...
      network_mode: {
        ...
        warn: 'Grove Control, Docker köprü ağı kullanılarak çalışıyor. Yazıcı keşfi ve Sanal Yazıcı, ana bilgisayar ağ modu gerektirir — konteyneri "network_mode: host" ile yeniden oluşturun.',
        skip: 'Docker\'da çalışmıyor — uygulanamaz.',
      },
      subnet: {
        title: 'Ağ alt ağı',
        pass: 'Yazıcı ve Grove Control aynı alt ağda.',
        warn: 'Yazıcı ({{printer_ip}}) ve Grove Control ({{host_ip}}) farklı alt ağlarda. Alt ağlar arasında yönlendirme yapılandırılmazsa birbirlerine erişemeyebilirler.',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: 'Erişim kodunu yazıcı ekranından (LAN ayarları) yeniden kopyalayın ve Grove Control\'deki yazıcının ayarlarında güncelleyin.',
      },
      'ftp-connection-timeout': {
        name: 'Dosya aktarım bağlantısı zaman aşımına uğradı',
        cause: 'Grove Control yazıcının dosya aktarım portuna (FTPS 990) erişemedi. Port engellendi veya yazıcı kapalı ya da başka bir alt ağda.',
        fix: 'Grove Control ile yazıcı arasında hiçbir şeyin port 990\'ı engellemediğinden ve her ikisinin de aynı ağda olduğundan emin olun.',
      },
      'ftp-ssl-error': {
      ...
      'database-locked': {
        ...
        fix: 'Grove Control\'yi harici bir PostgreSQL veritabanına geçirin. Dokümantasyondaki PostgreSQL kılavuzuna bakın.',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        ...
        fail: 'Sanal yazıcı etkin ancak servisleri çalışmıyor. Grove Control günlüğünü kontrol edin — bir bind IP çakışması veya bir izin hatası genellikle onları durdurur.',
      },
      bind_interface: {
      ...
      certificate: {
        ...
        pass: 'Sertifika hazır. Grove Control CA sertifikasının (yukarıda) dilimleyicinizin güven deposuna içe aktarıldığından emin olun.',
        fail: 'Bu sanal yazıcı için TLS sertifikası eksik. Grove Control veri dizininin yazılabilir olduğunu kontrol edin.',
      },
    },
  },
  failureDetection: {
    ...
    externalUrlHint: 'ML API, kamera anlık görüntüsünü URL üzerinden alır. ML API konteyneri Grove Control\'ye erişebilsin diye Genel ayarlarda Harici URL\'yi ayarlayın.',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: 'Bambu Handy uygulamasına gitmeden — doğrudan Grove Control\'den içe aktarmak ve yazdırmak için bir MakerWorld model URL\'si yapıştırın.',
    ...
    disclaimer: 'MakerWorld entegrasyonu topluluk tarafından belgelenen API uç noktalarını kullanır. Grove Control, MakerWorld veya Bambu Lab ile ilişkili veya onaylı değildir.',
  ...
  libraryPurge: {
    ...
    effect4: 'Harici (bağlı) klasörlerdeki dosyalar atlanır — Grove Control asla sahibi olmadığı bayt\'ları silmez.',
